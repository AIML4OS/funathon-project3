...
minio_url = "https://minio.lab.sspcloud.fr/"
s3_base   = "projet-formation/diffusion/funathon/2026/project3/data/images/LU000/2024/"

fg_img = folium.FeatureGroup(name="__", show=__)  # TODO: layer name (str), visible by default (bool)

tile_filenames = gdf_nuts["__"].unique().tolist()  # TODO: column containing tile filenames
...
tile_filenames = gdf_nuts["filename"].unique().tolist()
