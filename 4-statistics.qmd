...
higher opacity. Hovering over a polygon should show its class name and area.
...
4. Add a `GeoJson` layer with `fillOpacity` set to `0.7` for sealed
   (label 1) and `0.4` otherwise, coloured with `label_to_color`
...
folium.GeoJson(
    ...
    style_function=lambda feature: {
        "fillColor":   label_to_color.get(feature["properties"]["__"], "#808080"),  # TODO: key
        "color":       "black",
        "weight":      0.3,
